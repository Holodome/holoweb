...
//
// pub fn get_user_by_id(conn: &Conn, user_id: &str) -> Result<Option<domain::users::User>> {
...
// }
//
// pub fn get_user_by_name(conn: &Conn, user_name: &str) -> Result<Option<domain::users::User>> {
//     use crate::schema::users::dsl::*;
//
//     Ok(users
...
// }
//
// pub fn get_user_by_email(conn: &Conn, user_email: &str) -> Result<Option<domain::users::User>> {
//     use crate::schema::users::dsl::*;
//
//     Ok(users
...
// }
//
// pub fn get_all_users(conn: &Conn) -> Result<Vec<domain::users::User>> {
//     use crate::schema::users::dsl::*;
//
//     Ok(users.load::<domain::users::User>(conn)?)
// }
//
// pub fn add_user(conn: &Conn, item: domain::users::NewUser) -> Result<User> {
//     use crate::schema::users::dsl::*;
//
...
// }
//
// pub fn update_user(conn: &Conn, item: domain::users::UpdateUser) -> Result<Option<User>> {
//     use crate::schema::users::dsl::*;
//     diesel::update(users.filter(id.eq(item.id)))
//         .set(&item)
//         .execute(conn)?;
//
...
// }
//
// pub fn add_blog_post(
//     conn: &Conn,
//     item: domain::blog_posts::NewBlogPost,
...
//     conn: &Conn,
//     item: domain::blog_posts::UpdateBlogPost,
// ) -> Result<Option<domain::blog_posts::BlogPost>> {
//     use crate::schema::blog_posts::dsl::*;
//
...
// }
//
// pub fn get_comments_by_post_id(
//     conn: &Conn,
//     required_post_id: &str,
